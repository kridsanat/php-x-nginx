...
?>
                                ...
                                <table width="575" height="19" border="0" cellpadding="1" cellspacing="1">
								  ...
								  <form method="post" action="nu_ssdseditphotosave.php" enctype="multipart/form-data" name="webFormSearch" onSubmit="return checksearch()">
								  
									<tr bgcolor="#FFFFFF"> 
                                      <td> <div align="right"><font size="2"></font></div></td>
                                      <td><font size="3"> 
                                        <input name="info4" type="hidden" class="input" id="info4" size="40" value='<?php echo $info4; ?>' maxlength="100">
                                        </font></td>
                                    </tr>
									 ...
									 <tr bgcolor="#FFFFFF"> 
                                      <td> <div align="right"><font size="2"></font></div></td>
                                      <td><font size="3"> 
                                        <input name="info5" type="hidden" class="input" id="info5" value='<?php echo $info5; ?>' size="40">
                                        </font></td>
                                    </tr>
								  
                                    <tr bgcolor="#FFFFFF"> 
                                      <td width="140"> <div align="right"><font size="2"></font></div></td>
                                      <td width="428"><font size="3"> 
                                        <input name="info1" type="hidden"  id="info1" class="input" value='<?php echo $info1; ?>' size="5">
									...
									<tr bgcolor="#FFFFFF"> 
                                      <td> <div align="right"><font size="2"></font></div></td>
                                      <td><font size="3"> 
                                        <input name="info6" type="hidden" class="input" id="info6" value='<?php echo $info6; ?>' size="40">
                                        </font></td>
                                    </tr>
